  ...
  return (
    <Router>
      ...
      <HotAccessoriesMenu/>
        ...
        <Route exact path="/mobileAccessories" element={ <HotAccessories mobileAccessories={data.hotAccessories.mobileAccessories} homeCover={data.hotAccessoriesCover.mobileAccessories}  />  }/>
