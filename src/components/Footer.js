...
const Footer = ({footer}) => {
    return (
       <>
        ...
        <div className="PreFooter2">
             ...
             <div>
                 ...
                 <span>Thanks. You're on my email list for special offers.</span>
             </div>

             <div>
                    <p>FOLLOW ASHISH MI</p>
        ...
        <div className="footer">
                 ...
                 <p> CONTACT US</p>
                  ...
                  <div>
                      <div>Chat with our Virtual AI Bot(24/7 Live Agent Support)</div><button>CHAT WITH ASHISH</button>
                  </div>
       ...
       <div> Copyright © 2010 - 2021 Xiaomi. All Rights Reserved-ASHISH-MI-Clone</div>
        </div>
